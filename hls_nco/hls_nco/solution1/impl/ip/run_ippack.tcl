...
set sdx_kernel_name "nco"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "C:/Users/tri/Documents/HK1NAM4/HWSW/project/hls_nco/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {nco_sine_lut_V
nco_AXILiteS_s_axi
nco
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 sine_sample_V R 0x0 "Data signal of sine_sample_V" {{0 16 sine_sample_V R 0 "Bit 15 to 0 Data signal of sine_sample_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x14 sine_sample_V_ctrl R 0x0 "Control signal of sine_sample_V" {{0 1 sine_sample_V_ap_vld R 0 "Control signal sine_sample_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 step_size_V W 0x0 "Data signal of step_size_V" {{0 16 step_size_V W 0 "Bit 15 to 0 Data signal of step_size_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
