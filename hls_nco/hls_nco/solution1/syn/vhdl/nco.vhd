...
architecture behav of nco is 
    ...
    "nco,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.331000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=98,HLS_SYN_LUT=142,HLS_VERSION=2019_1}";
...
begin
    ...
    sine_lut_V_address0 <= zext_ln434_fu_89_p1(12 - 1 downto 0);
    ...
    zext_ln434_fu_89_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(address_V_fu_79_p4),64));
end behav;
