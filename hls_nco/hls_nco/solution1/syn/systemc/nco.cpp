...
nco::nco(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_zext_ln434_fu_89_p1);
    ...
    sc_trace(mVcdFile, zext_ln434_fu_89_p1, "zext_ln434_fu_89_p1");
...
void nco::thread_sine_lut_V_address0() {
    sine_lut_V_address0 =  (sc_lv<12>) (zext_ln434_fu_89_p1.read());
}
...
void nco::thread_zext_ln434_fu_89_p1() {
    zext_ln434_fu_89_p1 = esl_zext<64,12>(address_V_fu_79_p4.read());
}
